...
import { rejectAdminResource, UUID_REGEX } from "@/lib/services/admin-resources";
 ...
 *
 * Transitions a resource from 'pending' to 'rejected'.
 * Sets verified_by = null and verified_at = null.
...
export async function POST(
  ...
  const result = await rejectAdminResource(id);
