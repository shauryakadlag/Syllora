...
import { resolveAdminResourceReport, UUID_REGEX } from "@/lib/services/admin-reports";
...
/**
 * POST /api/admin/resource-reports/[id]/resolve
 *
 * Transitions a resource report from 'open' to 'resolved'.
...
export async function POST(
  ...
  const result = await resolveAdminResourceReport(id, authResult.user.id);
